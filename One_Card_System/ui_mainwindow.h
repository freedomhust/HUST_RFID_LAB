...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        action_lostandfound = new QAction(MainWindow);
        action_lostandfound->setObjectName(QStringLiteral("action_lostandfound"));
        ...
        menu_2->addSeparator();
        menu_2->addAction(action_lostandfound);
...
#endif // QT_NO_STATUSTIP
        action_lostandfound->setText(QApplication::translate("MainWindow", "\347\224\250\346\210\267\346\214\202\345\244\261", Q_NULLPTR));
