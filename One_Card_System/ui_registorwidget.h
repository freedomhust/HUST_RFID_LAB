...
public:
    ...
    void setupUi(QWidget *RegistorWidget)
    {
        ...
        label_uesr_type = new QLabel(groupBox);
        label_uesr_type->setObjectName(QStringLiteral("label_uesr_type"));
        label_uesr_type->setFont(font);

        gridLayout->addWidget(label_uesr_type, 1, 0, 1, 1);
        ...
        gridLayout->addWidget(comboBox_UserType, 1, 1, 1, 1);
        ...
        label_studentID = new QLabel(groupBox);
        label_studentID->setObjectName(QStringLiteral("label_studentID"));
        label_studentID->setFont(font);
        label_studentID->setLayoutDirection(Qt::LeftToRight);
        label_studentID->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(label_studentID, 5, 0, 1, 1);

        label_phone = new QLabel(groupBox);
        label_phone->setObjectName(QStringLiteral("label_phone"));

        gridLayout->addWidget(label_phone, 4, 0, 1, 1);

        label_remark = new QLabel(groupBox);
        label_remark->setObjectName(QStringLiteral("label_remark"));
        label_remark->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(label_remark, 6, 0, 1, 1);

        lineEdit_studentID = new QLineEdit(groupBox);
        lineEdit_studentID->setObjectName(QStringLiteral("lineEdit_studentID"));

        gridLayout->addWidget(lineEdit_studentID, 5, 1, 1, 1);

        lineEdit_PersonMark = new QLineEdit(groupBox);
        lineEdit_PersonMark->setObjectName(QStringLiteral("lineEdit_PersonMark"));

        gridLayout->addWidget(lineEdit_PersonMark, 6, 1, 1, 1);
        ...
        lineEdit_CardId->setReadOnly(false);
    ...
    void retranslateUi(QWidget *RegistorWidget)
    {
        ...
        label_uesr_type->setText(QApplication::translate("RegistorWidget", "\350\272\253\344\273\275\347\261\273\345\236\213\357\274\232", Q_NULLPTR));
        ...
        label_name->setText(QApplication::translate("RegistorWidget", "\345\247\223\345\220\215\357\274\232", Q_NULLPTR));
        label_studentID->setText(QApplication::translate("RegistorWidget", "\345\255\246\345\217\267\357\274\232", Q_NULLPTR));
        label_phone->setText(QApplication::translate("RegistorWidget", "\347\224\265\350\257\235\345\217\267\347\240\201\357\274\232", Q_NULLPTR));
        label_remark->setText(QApplication::translate("RegistorWidget", "\345\244\207\346\263\250\357\274\232", Q_NULLPTR));
