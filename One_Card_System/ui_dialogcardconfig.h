...
public:
    ...
    void setupUi(QDialog *DialogCardConfig)
    {
        ...
        DialogCardConfig->resize(422, 154);
        ...
        label_initValue = new QLabel(DialogCardConfig);
        label_initValue->setObjectName(QStringLiteral("label_initValue"));
        label_initValue->setFont(font);

        horizontalLayout_4->addWidget(label_initValue);
    ...
    void retranslateUi(QDialog *DialogCardConfig)
    {
        ...
        label_initValue->setText(QApplication::translate("DialogCardConfig", "\345\210\235\345\247\213\345\214\226\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
